...
class OrderCreateSerializer(serializers.Serializer):
    ...
    lot_number = serializers.CharField(max_length=255, allow_blank=True, allow_null=True)
    ...
    border_crossing = serializers.CharField(max_length=255, allow_blank=True, allow_null=True)
    ...
    departure_country = serializers.CharField(max_length=255, allow_blank=True, allow_null=True)
    destination_country = serializers.CharField(max_length=255, allow_blank=True, allow_null=True)
