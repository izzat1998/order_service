...
def test_detail_station(client, departure):
    response = client.get(f"/api/core/stations/{departure.id}/")
...
def test_list_station(client, product, departure, destination):
    response = client.get("/api/core/stations/")
...
def test_create_station(client):
    response = client.post('/api/core/stations/',
...
def test_update_station(client, destination):
    response = client.put(f'/api/core/stations/{destination.id}/',
