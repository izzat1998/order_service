...
def test_list_counterparty_order(client, counterparty_order2):
    response = client.get(f'/api/container_order/counterparty_list/', content_type='application/json')
...
def test_update_counterparty_order(client, counterparty_order2, counterparty_2, category_2):
    ...
    response = client.put(f'/api/container_order/counterparty_update/{counterparty_order2.id}/',
...
def test_create_counterparty_order(client, container_order, counterparty_2, category_2):
    ...
    response = client.post('/api/container_order/counterparty_create/', data=counterparty_order,
                           content_type='application/json')
...
def test_delete_counterparty_order(client, counterparty_order2):
    response = client.delete(f'/api/container_order/counterparty_delete/{counterparty_order2.id}/',
                             content_type='application/json')
